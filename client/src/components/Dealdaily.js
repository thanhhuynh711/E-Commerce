...
const Dealdaily = () => {
  ...
  const fetchDealDaily = async () => {
    ...
    if (response.success) {
      ...
      const today = `${moment().format("MM/DD/YY")} 00:00:00`;
      const seconds =
  ...
  return (
    <div className="border w-full flex-auto">
      <div className="flex items-center justify-between p-4">
        ...
        <span className="flex-6 text-center font-semibold text-gray-700 text-[20px]">
          DAILY DEALS
        </span>
      ...
      <div className="px-4 mt-4 ">
        ...
        <button
          type="button"
          className="flex gap-2 items-center justify-center py-2 w-full bg-main hover:bg-gray-800 text-white font-medium"
        >
