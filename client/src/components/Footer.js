      ...
      <div className="h-[103px] w-full bg-main flex items-center justify-center">
        <div className="w-main flex items-center justify-between">
          <div className="flex flex-col flex-1">
            ...
            <smail className="text-[13px] text-gray-300">
          ...
          <div className="flex-1 flex items-center">
            ...
            />
            <div className="h-[56px] bg-[#F04646] flex items-center justify-center rounded-r-full w-[56px] text-gray-100">
              <MdEmail size={18} />
            </div>
          </div>
        </div>
      </div>
      <div className="h-[407px] w-full bg-gray-900 flex items-center text-white text-[13px] justify-center">
        <div className="w-main flex">
          <div className="flex-2 flex flex-col gap-2">
            <h3 className="mb-[20px] text-[15px] font-medium border-l-4 pl-[15px] border-main">
              ABOUT US
            </h3>
            <span className="">
              <span>Address: </span>
